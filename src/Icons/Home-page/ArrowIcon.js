const ArrowIcon = () => {
    return ( 
        <div>
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20px" height="20px" viewBox="0 0 30.021 30.021" >
                <g>
                    <path d="M29.069,22.276c-0.791,0.932-1.917,1.409-3.052,1.409c-0.913,0-1.834-0.312-2.587-0.949l-8.42-7.152l-8.42,7.151
                        ...
                        l11.011,9.351C30.294,18.068,30.499,20.591,29.069,22.276z" fill='white' stroke='black'/>
                </g>
            </svg>
        </div>
    );
