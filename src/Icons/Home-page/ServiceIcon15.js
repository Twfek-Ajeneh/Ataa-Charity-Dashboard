const ServiceIcon15 = () => {
    return ( 
        <div>
            <svg width='40' height='40' version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 296.096 296.096">
                <g>
                    <path d="M101.15,175.142c6.966,0,14.634,0.68,21.634,1.966v-20.969h51v37.424c6,2.203,10.381,4.579,14.494,7.567
                        ...
                        L148.047,49.23l-89.263,98.628v35.247c6-1.521,11.468-3.156,17.806-4.884C84.086,176.178,92.405,175.142,101.15,175.142z" fill='white' stroke='black' strokeOpacity='1' strokeWidth='10px'/>
                    <polygon points="148.446,25.313 247.63,136.139 270.251,136.139 148.247,0 97.784,55.572 97.784,33.139 60.784,33.139 
                        60.784,96.454 25.201,136.139 48.144,136.139" fill='white' stroke='black' strokeOpacity='1' strokeWidth='10px'/>
                    <path d="M259.083,214.931c-5.494,0-12.89,2.44-22.289,8.901c-17.182,11.811-38.215,17.012-57.433,17.012
                        ...
                        C274.323,227.998,271.797,214.931,259.083,214.931z" fill='white' stroke='black' strokeOpacity='1' strokeWidth='10px'/>
                </g>
            </svg>
        </div>
    );
}
export default ServiceIcon15;